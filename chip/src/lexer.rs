...
// math operators
let ADDITION_OPERATOR = "ADDITION_OPERATOR";
let SUBTRACTION_OPERATOR = "SUBTRACTION_OPERATOR";
let MULTIPLICATION_OPERATOR = "MULTIPLICATION_OPERATOR";
let DIVISION_OPERATOR = "DIVISION_OPERATOR";
let MODULUS_OPERATOR = "MODULUS_OPERATOR";
